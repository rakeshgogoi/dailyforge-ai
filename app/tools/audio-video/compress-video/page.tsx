...
import { CompressVideoForm } from "./compress-form";

const match = getTool("audio-video", "compress-video")!;

export const metadata = toolMetadata("audio-video", "compress-video");
...
export default function CompressVideoPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-8 sm:py-16">
      <ToolSeo category="audio-video" slug="compress-video" />
      ...
      <CompressVideoForm />
      <ToolPageAd />
      <ToolBottomSeo category="audio-video" slug="compress-video" />
    </div>
  );
}
