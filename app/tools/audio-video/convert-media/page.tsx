...
import { ConvertMediaForm } from "./convert-form";

const match = getTool("audio-video", "convert-media")!;

export const metadata = toolMetadata("audio-video", "convert-media");
...
export default function ConvertMediaPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <ToolSeo category="audio-video" slug="convert-media" />
      ...
      <ConvertMediaForm />
      <ToolBottomSeo category="audio-video" slug="convert-media" />
    </div>
  );
}
